...
class ProjectScannerGUI:
    ...
    def __init__(self, master):
        ...
        tk.Button(button_frame, text="Browse", command=self.browse_folder).pack(side=tk.LEFT)
        tk.Button(button_frame, text="Current Location \u2191", command=self.use_current_location).pack(side=tk.LEFT, padx=(5, 0))
    ...
    def use_current_location(self):
        """Set the project folder to the current working directory."""
